  ...
  return (
    <footer className="py-4 text-white bg-gray-700">
      ...
      <div className="container max-w-3xl mx-auto text-center px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li><a href="/grades" className="hover:underline">Grades</a></li>
              <li><a href="/schedule" className="hover:underline">Schedule</a></li>
              <li><a href="/StudentProgress" className="hover:underline">Progress</a></li>
        ...
        {/* Copyright */}
        <p className="text-xs">&copy; {new Date().getFullYear()} Student Progress Tracking System. All Rights Reserved.</p>
      </div>
    </footer>
  );
};
